...
public class ServerServiceTest {
    ...
    public void flushResult() {
        String traceId = "447eb726d7d5e8c9";
        String bodyStr = ""
        ...
        // System.out.println(MD5Util.byteToMD5(bodyStr.getBytes()));
        ServerService.flushResult(traceId, bodyStr.getBytes());

        // System.out.println("447eb726d7d5e8c9 : 3868E3714DCDA8A382075C7DF8728B2B");
    }
}